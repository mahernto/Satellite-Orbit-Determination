...
/// @brief Source file for AccelHarmonic function
/// @date 2025-04-15
...
Matrix AccelHarmonic(const Matrix& r, Matrix E, int n_max, int m_max){
    double gm, d, latgc, lon, dUdr, dUdlatgc, dUdlon,
    b1, b2, b3, q3, q2, q1, r2xy, ax, ay, az;
    ...
    Matrix a_bf = Matrix(3,1, values, 3);
