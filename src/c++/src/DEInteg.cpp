...
void DEInteg(Matrix (*func)(double, const Matrix &), double t, double tout, double relerr, double abserr, int n_eqn,
             Matrix &y) {
    // Variable declaration
    int State_ = 0, ki = 0, kold = 0, k = 0, kp1 = 0, kp2 = 0, km1 = 0, km2 = 0, ns = 0, nsp1 = 0, realns = 0, im1 = 0, reali = 0, nsm2 = 0, limit1 = 0, nsp2 = 0, limit2 = 0, knew = 0;
    bool PermitTOUT = false, start = false, OldPermit = false, crash = false, phase1 = false, nornd = false, success = false;
    double x = 0.0, twou = 0.0, fouru = 0.0, temp1 = 0.0, told = 0.0, delsgn = 0.0, h = 0.0, hi = 0.0, term = 0.0, psijm1 = 0.0, gamma = 0.0, eta = 0.0, sum = 0.0, absh = 0.0, hold = 0.0, hnew = 0.0, temp2 = 0.0, temp3 = 0.0, temp4 = 0.0, temp5 = 0.0, temp6 = 0.0, tau = 0.0, xold = 0.0, erkm2 = 0.0, erkm1 = 0.0, erk = 0.0, err = 0.0, erkp1 = 0.0, r = 0.0;

    // maxnum = 500;
    twou = 2 * std::numeric_limits<double>::epsilon();
    fouru = 4 * std::numeric_limits<double>::epsilon();
    ...
    while (true) {   // Start step loop
        ...
        if (fabs(x - t) >= absdel) {
            ...
            for (int j = 1; j <= ki; j++) {
                int i = ki + 1 - j;
                yout = yout + g(i + 1) * phi.getColumn(i + 1);
                ypout = ypout + rho(i + 1) * phi.getColumn(i + 1);
            }
            yout = y + hi * yout;
            y = yout;
